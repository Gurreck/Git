...
def registrarUsuario(nombre, password):
    ...
    if nombre and password:
        ...
        with open('Controller/usuarios.txt', 'w') as outfile:
            outfile.write(json.dumps(data))
def autenficarUsuario(nombre, password):
	with open('Controller/usuarios.txt') as file:
		data = json.load(file)
...
"font-weight: bold;")
        ...
        self.btn_registrarse.clicked.connect(lambda: registrarUsuario(self.text_usuarioRegistro.text(),self.text_passwordRegistro.text()))
        self.btn_iniciarSesion.clicked.connect(lambda: autenficarUsuario(self.text_usuario.text(),self.text_password.text()))
